	...
	createExpectations := []TestExpectation{
		{
			...
			ExpQualifiedName: "com.test.case1.Outer.StaticInner",
			ExpKind:          model.Class,
			ExpIsExternal:    false,
		},
		// 该语法当前暂不支持
		...
		//	ExpQualifiedName: "com.test.case1.Outer.MemberInner",
		//	ExpKind:          model.Class,
		//	ExpIsExternal:    false,
		//},
		{
		...
		},
		{
			...
			ExpQualifiedName: "com.test.case1.Builder",
			ExpKind:          model.Class,
			ExpIsExternal:    false,
		},
		{
			...
			ExpQualifiedName: "com.test.case1.Product",
			ExpKind:          model.Class,
			ExpIsExternal:    false,
		},
		{
...
func TestSymbolResolver_Throw(t *testing.T) {
	...
	throwExpectations := []TestExpectation{
		// 维度 1: 基础实例化抛出
		{
			...
			LineNum:          15,
			TargetText:       "new CustomException(\"object is null\")",
		...
		},
		{
			Name:             "场景 1.2: 标准库异常抛出",
			LineNum:          20,
			TargetText:       "new IllegalArgumentException(\"invalid flag\")",
			ExpQualifiedName: "IllegalArgumentException",
			ExpKind:          model.Class,
			ExpIsExternal:    true,
		},
		{
			...
			LineNum:          25,
			TargetText:       "new UnknownException()",
		...
		},
		{
			...
			LineNum:          40,
			TargetText:       "ex",
			ExpQualifiedName: "RuntimeException",
			ExpKind:          model.Class,
			ExpIsExternal:    true,
		},
		...
		// 维度 3: 工厂方法与复杂表达式抛出
		{
			...
			LineNum:          48,
			TargetText:       "ExceptionFactory.createException()",
			ExpQualifiedName: "com.test.case1.CustomException",
			ExpKind:          model.Class,
			ExpIsExternal:    false,
		},
		{
			...
			LineNum:          53,
			TargetText:       "(RuntimeException) obj",
			ExpQualifiedName: "RuntimeException",
			ExpKind:          model.Class,
			ExpIsExternal:    true,
		},
